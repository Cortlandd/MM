          ...
          {additionalOptionsVisible ? (
            ...
            >
              <TouchableOpacity>
                {Platform.OS === 'android' ? (
                  <Avatar
                    source={icons.messenger_dot_icon}
                    size={18}
                    avatarStyle={{ tintColor: '#09F' }}
                  />
                ) : (
              ...
              <TouchableOpacity>
                {/*<Icon name={'photo'} style={{ borderRadius: 10 }} type={'foundation'} size={30} color={'#09F'} />*/}
                <Svg viewBox="0 0 36 36" height={35} width={35}>
                  <Path d="M13.5 16.5a2 2 0 100-4 2 2 0 000 4z" fill="#09F" />
                  <Path
                    fillRule="evenodd"
                    clipRule="evenodd"
        ...
        <Col style={{ height: 38 }}>
          <View style={styles.msgInputWrapper}>
            <TextInput
              ...
              placeholder={
                additionalOptionsVisible ? 'Aa' : 'Type a message...'
              }
            />
