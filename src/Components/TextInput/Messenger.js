      ...
      {additionalOptionsVisible ? (
        <Animated.View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', width: '50%' }}>
          ...
          <TouchableOpacity style={styles.btnNavigation}>
            <Icon name={'camera'} type={'ionicon'} size={30} color={'#0099FF'} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.btnNavigation}>
            <Icon name={'photo'} style={{ borderRadius: 10 }} type={'foundation'} size={30} color={'#0099FF'} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.btnNavigation}>
            <Avatar source={icons.facebook_microphone} size={23} avatarStyle={{ tintColor: '#0099FF' }} />
          </TouchableOpacity>
        </Animated.View>
      ) : (
        <Animated.View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <TouchableOpacity style={styles.btnNavigation} onPress={() => setAdditionalOptionsVisible(true)}>
            <Icon name={'chevron-right'} type={'feather'} size={30} color={'#0099FF'} />
          </TouchableOpacity>
        </Animated.View>
      )}
