...
const MessengerConversation = ({ navigation, route }: Props) => {
  ...
  const handleMessageData = (msg: Message) => {
    ...
    var latestMessage = conversationMessages.reduce((a, b) => {
    ...
    let latestMessageIndex = conversationMessages.findIndex(v => v.time === latestMessage.time)
    let previousMessage: Message = conversationMessages[latestMessageIndex]
